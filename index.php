...
<head>
    ...
    <title>Fingerprint Section</title>
...
<body>
    <div class="container">
        <header>
            <div class="logo">
                <a href="https://spotter.ai/" class="sc-fAGzit dkkWFz"><svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 944.7 623.7" xml:space="preserve" height="20">
                        <style type="text/css">
                            .st0 {
                                fill: #008080;
                            }
            ...
            <div class="action-buttons">
                <div class="d-large">
                    <a href="#!" class="btn btn-nav btn-no-border">Login</a>
                    <a href="#!" class="btn btn-nav btn-outline">Contact Sales</a>
                    <a href="#!" class="btn btn-nav btn-brand">Get Started</a>
                </div>
        ...
        <div class="action-buttons-small d-small">
            <a href="#!" class="btn btn-nav btn-no-border">Login</a>
            <a href="#!" class="btn btn-nav btn-outline">Contact Sales</a>
            <a href="#!" class="btn btn-nav btn-brand">Get Started</a>
        </div>
        <div class="section">
            <div class="left-column">
                <div>
                    <div class="tag">Why Fingerprint</div>
                    <h1>
                        Get more out of each mile <br />
                        with <span class="highlight">Spotter</span>
                    </h1>
                    <p class="subtitle">
                        AI technology that gets you <strong>hot loads</strong>
                    </p>
                </div>
                <a href="#!">
            ...
            <div class="right-column">
                <div class="card">
                    <h3>1. ready now</h3>
                    <p>set the times when you will be ready.</p>
                </div>
                <div class="card">
                    <img src="img/step2.gif" alt="step2" />
                    <h3>2. select destinations</h3>
                    <p>select the markets you want to go to, avoid bad markets via NO-GO map.</p>
                </div>
                <div class="card">
                    <h3>3. spotter recommends loads</h3>
                    <p>get matched with the highest load score offers</p>
                </div>
            </div>
        </div>
    </div>
